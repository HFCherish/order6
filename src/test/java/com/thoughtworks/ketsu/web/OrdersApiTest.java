...
public class OrdersApiTest extends ApiSupport {
    ...
    public void should_get_order_success() {
        ...
        verifyBasicOrderInf(order, orderInfo);
    ...
    private void verifyBasicOrderInf(Order order, Map orderInfo) {
    ...
    @Test
    public void should_404_when_get_order_not_exists() {
        Order order = prepareOrder(product, user);
    ...
    public void should_get_all_orders() {
        ...
        verifyBasicOrderInf(order, (Map)orders.get(0));
